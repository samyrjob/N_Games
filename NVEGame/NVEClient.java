...
public class NVEClient extends JFrame {
    ...
    public NVEClient() {
        ...
        this.myX = 400;
        this.myY = 300;
        this.otherUsers = new ConcurrentHashMap<>();
    ...
    private void connectToServer() {
        try {
            ...
            // If user cancels or enters empty, keep default "Guest" username
...
public void addUser(String username, double x, double y) {
    if (!username.equals(this.username)) {
        ...
        updateUserList();
        worldPanel.repaint(); // FIX: Repaint to show new user
    }
}
    ...
    } else if (parts[0].equals("SYSTEM")) {
        // FIX: Add system messages to chat
